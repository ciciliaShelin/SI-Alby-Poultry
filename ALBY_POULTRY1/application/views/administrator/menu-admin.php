        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#"><i class="glyphicon glyphicon-th-list"></i> <span>Web</span><i class="fa fa-angle-left pull-right"></i></a>
              ...
              <?php
                ...
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li hidden><a href='".base_url()."administrator/menuwebsite'><i class='fa fa-circle-o'></i> Menu Website</a></li>";
                }
                ...
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li hidden><a href='".base_url()."administrator/download'><i class='fa fa-circle-o'></i> Download Area</a></li>";
                }
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-gears"></i> <span>Menu Utama</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                  <?php 
                    ...
                    if($cek==1 OR $this->session->level=='admin'){
                      echo "<li><a href='".base_url()."administrator/tambah_pembelian'><i class='fa fa-circle-o'></i> Tambah Stok Barang</a></li>";
                    }
                  ?>
              </ul>
            </li>
            ...
            <li class="treeview">
              <a href="#"><i class="glyphicon glyphicon-pencil"></i> <span>Berita</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <?php
