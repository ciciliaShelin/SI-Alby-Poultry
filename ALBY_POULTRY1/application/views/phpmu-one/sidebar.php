            ...
            <?php 
                ...
                //       }else {
                //            echo "<div><a target='_BLANK' title='".$row['judul']."' href='".$row['url']."'><img style='height:20px;' class='img-thumbnail' width='100%' src='".base_url()."asset/foto_iklan/".$row['gambar']."'></a></div>";
                //       }
                //     }
                // }
            ?>
