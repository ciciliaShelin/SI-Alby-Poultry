            ...
            <?php 
              ...
              echo "<div class='col-sm-6'>
                        <center><img style='min-height:88px; weight:100px; width:60%' src='".base_url()."asset/foto_produk/$foto_produk'></center>
                    </div>
                    <div class='col-sm-6'>
                          ...
                          Quantity <input class='form-control ' type='number' name='jumlah' value='1' style='width:150px; diplay:inline-block'><br>
                                       <textarea class='hidden ' type='number' name='keterangan' placeholder='Ex : Ukuran, warna, dll'></textarea><br>
