        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?=base_url('assets/asset/');?>images/model_1_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?=base_url('assets/asset/');?>images/model_2_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?=base_url('assets/asset/');?>images/model_3_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?=base_url('assets/asset/');?>images/model_4_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?=base_url('assets/asset/');?>images/model_5_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="<?=base_url('assets/asset/');?>images/product_1_bg.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
