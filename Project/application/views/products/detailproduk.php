	...
	<div class="row">	  
            ...
            <a href="<?= base_url('assets/'); ?>themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="<?= base_url('assets/'); ?>themes/images/products/large/3.jpg" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="<?= base_url('assets/'); ?>themes/images/products/large/f1.jpg"> <img style="width:29%" src="<?= base_url('assets/'); ?>themes/images/products/large/f1.jpg" alt=""/></a>
                   <a href="<?= base_url('assets/'); ?>themes/images/products/large/f2.jpg"> <img style="width:29%" src="<?= base_url('assets/'); ?>themes/images/products/large/f2.jpg" alt=""/></a>
                   <a href="<?= base_url('assets/'); ?>themes/images/products/large/f3.jpg" > <img style="width:29%" src="<?= base_url('assets/'); ?>themes/images/products/large/f3.jpg" alt=""/></a>
                  </div>
                  <!-- <div class="item">
                   <a href="<?= base_url('assets/'); ?>themes/images/products/large/f3.jpg" > <img style="width:29%" src="<?= base_url('assets/'); ?>themes/images/products/large/f3.jpg" alt=""/></a>
                   <a href="<?= base_url('assets/'); ?>themes/images/products/large/f1.jpg"> <img style="width:29%" src="<?= base_url('assets/'); ?>themes/images/products/large/f1.jpg" alt=""/></a>
