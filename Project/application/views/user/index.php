...
<html lang="en">
  <head>
    ...
    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="fonts/icomoon/style.css">

    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="css/bootstrap.min.css">
    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="css/jquery-ui.css">
    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="css/owl.carousel.min.css">
    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="css/owl.theme.default.min.css">
    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="css/owl.theme.default.min.css">

    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="css/jquery.fancybox.min.css">

    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="css/bootstrap-datepicker.css">

    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="fonts/flaticon/font/flaticon.css">

    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="css/aos.css">

    <link rel="<?= base_url('assets/asset/') ?>stylesheet" href="css/style.css">
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Putri Nur Rahmatillah</span>
